...
<body>
<div class="form_div">
    <form action="signup.php" method="post" id="registration" class="validation_singupform">
        <ul class="form_ul">
            <li>
                <label class="main_label" for="login">Login</label>
                <input type="text" name="login" id="login" class="login required_field" placeholder="login" value="<?php echo @$login;?>">
            </li>
            <li>
                <label class="main_label" for="email">E-mail</label>
                <input type="email" name="email" id="email" class="email required_field" placeholder="email@gmail.com" value="<?php echo @$email;?>">
            </li>
            <li>
                <label class="main_label" for="real_name">Real name</label>
                <input type="text" name="real_name" id="real_name" class="real_name required_field" placeholder="real name" value="<?php echo @$real_name;?>">
            </li>
            <li>
                <label class="main_label" for="password">Password</label>
                <input type="password" name="password" id="password" class="password required_field" placeholder="password">
            </li>
            <li>
                <label class="main_label" for="confirmpassword">Confirm password</label>
                <input type="password" name="confirmpassword" id="confirmpassword" class="confirmpassword required_field" placeholder="confirm password">
            </li>
            <li>
